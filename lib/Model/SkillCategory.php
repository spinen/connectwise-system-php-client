...
/**
 * SkillCategory Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\System
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillCategory implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillCategory';
    ...
    {
        if ((strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SkillCategory., must be smaller than or equal to 30.');
        }
